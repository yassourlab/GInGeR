...
class GeneContigMatch:
    def __init__(self, paf_line: PafRecord):
        self.gene = paf_line.qname
        self.gene_length = paf_line.qlen
        self.gene_start = paf_line.qstart
        self.gene_end = paf_line.qend

        self.strand = paf_line.strand

        self.contig = paf_line.tname
        self.contig_length = paf_line.tlen
        self.contig_start = paf_line.tstart
        self.contig_end = paf_line.tend

        self.match_score = paf_line.mlen / self.gene_length
